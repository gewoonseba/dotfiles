---
name: create-issue
description: Create a GitHub issue with proper type, project assignment, and sprint/backlog placement using the GitHub GraphQL API
---

# Create GitHub Issue

## Overview
Create a GitHub issue with proper type, project assignment, and sprint/backlog placement using the GitHub GraphQL API.
