---
name: create-pr
description: Create a pull request for the current branch. Assume the user is happy with the current branch state and wants it up for review — commit and push anything that's missing without asking.
---
